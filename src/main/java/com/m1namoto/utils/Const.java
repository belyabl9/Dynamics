...
public class Const {
    ...
    public static class ActionURIs {
        public static String USERS_PAGE = "/page/users";
        public static String ADD_USER_PAGE = "/page/addUser";
        public static String UPDATE_USER_INFO_AJAX = "/ajax/updateUserInfo";
        public static String USER_INFO_PAGE = "/page/userInfo";
        public static String USERS_LIST_AJAX = "/ajax/users";
